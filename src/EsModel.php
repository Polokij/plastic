...
trait EsModel
{
    //Primary key auto-generated by elasticsearch has a name _id by default
    /** @var string $primaryKey */
    protected $primaryKey = '_id';

    // Default dateTime format for Elasticsearch
    ...
    protected function performUpdateElasticSearch()
    {
        ...
        if (count($dirty) > 0) {
            ...
            $this->original = $client->update($params);
    ...
    protected function performInsertElasticSearch()
    {
        ...
        $this->original = $client->index($params);
